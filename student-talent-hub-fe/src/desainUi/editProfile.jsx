...
export default function EditProfile() {
  ...
  // State untuk form data (Mockup data sesuai gambar referensi)
  const [formData, setFormData] = useState({
    fullName: "Alexander Julian Hartanto",
    nim: "210984212",
    major: "Computer Science & Information Technology",
    bio: "Passionate final-year student specializing in full-stack web development and user experience design. I love bridging the gap between technical functionality and beautiful aesthetics. Currently looking for innovative internship opportunities in the tech sector.",
    isPublic: true,
  });
  ...
  const handleSave = (e) => {
    e.preventDefault();
    // Panggil API PUT /users/me di sini nantinya
    console.log("Saved data:", formData);
    navigate("/profile"); // Kembali ke halaman profil setelah simpan
  };
