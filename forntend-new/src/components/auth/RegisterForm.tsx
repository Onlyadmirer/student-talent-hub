    ...
    <div className='flex flex-col h-full'>
      ...
      <div className='flex items-center justify-center flex-1 w-full'>
        <div className='bg-white w-full max-w-[460px] rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.03)] p-10 border border-[#f3f4f6]'>
          <h2 className='text-[1.75rem] font-bold text-primary mb-2'>
            Create Account
          </h2>
          ...
          <form onSubmit={handleSubmit}>
            <div className='mb-5'>
              ...
              <div className='flex bg-[#f3f4f6] p-1 rounded-lg'>
                ...
                >
                  <IdentificationCardIcon size={18} /> StudentIcon
                </button>
                <button
                  type='button'
                  onClick={() =>
                ...
                >
                  <BriefcaseIcon size={18} /> Recruiter
                </button>
              </div>
            </div>
            ...
            <div className='mb-5'>
              <label
                htmlFor='fullname'
                className='block text-xs font-semibold text-[#374151] mb-2'
              >
                Full Name
              </label>
              <div className='relative flex items-center'>
                <UserIcon
                  size={20}
                  className='absolute left-[14px] text-[#9ca3af]'
                />
                <input
                  id='fullname'
                  type='text'
              ...
              <div className='flex gap-4 mb-5 max-md:flex-col max-md:gap-0'>
                ...
                <div className='flex-1'>
                  ...
                  <div className='relative flex items-center'>
                    <GraduationCapIcon
                      size={20}
                      className='absolute left-[14px] text-[#9ca3af] z-10'
                    />
                    <select
                      id='major'
                      value={form.major}
                      onChange={update("major")}
                      className='w-full py-3 pl-[42px] pr-[14px] border border-[#e5e7eb] rounded-lg text-sm text-[#111] outline-none appearance-none bg-white focus:border-primary focus:shadow-[0_0_0_3px_rgba(0,77,64,0.1)]'
                      required
                    >
            ...
            <div className='mb-5'>
              ...
              <div className='relative flex items-center'>
                ...
                <input
                  ...
                  className='w-full py-3 pl-[42px] pr-[42px] border border-[#e5e7eb] rounded-lg text-sm text-[#111] outline-none focus:border-primary focus:shadow-[0_0_0_3px_rgba(0,77,64,0.1)] placeholder:text-[#6B7280]'
                  required
                />
                <button
                  type='button'
            ...
            <button
              type='submit'
              className='w-full p-[14px] bg-primary text-white border-none rounded-lg text-sm font-semibold cursor-pointer mt-2.5 hover:bg-primary-dark transition-colors font-body'
            >
              {isStudent ? "Register as StudentIcon" : "Register as Recruiter"}
            </button>
          </form>
